...
public class FullHybridVehicleRequestValidations : AbstractValidator<FullHybridVehicleRequest>
{
    public FullHybridVehicleRequestValidations()
    {
        RuleFor(x => x.VIN)
            .NotEmpty()
        ...
        RuleFor(x => x.PowerTrain)
            .NotNull()
            .WithMessage("{PropertyName} is required")
            .SetValidator(new HybridPowerTrainRequestValidations());
