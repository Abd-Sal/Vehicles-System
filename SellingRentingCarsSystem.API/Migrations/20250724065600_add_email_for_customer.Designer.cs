...
namespace SellingRentingCarsSystem.API.Migrations
{
    ...
    [Migration("20250724065600_add_email_for_customer")]
    partial class add_email_for_customer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SellingRentingCarsSystem.API.Models.PowerTrain", b =>
                {
                    ...
                    b.Property<string>("ChargePortType")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<string>("FuelDelivery")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("SellingRentingCarsSystem.API.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEH1S95fPtkbS7hblzIjuOVxCx+gCV1rO1aURKBM4ioz0h2pZ8KtB3KMdh3TrLuGgwA==",
            ...
            modelBuilder.Entity("SellingRentingCarsSystem.API.Models.Vehicle", b =>
                {
                    ...
                    b.HasOne("SellingRentingCarsSystem.API.Models.FuelType", "FuelType")
                        .WithMany("Vehicles")
